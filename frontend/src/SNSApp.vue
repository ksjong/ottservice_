        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="serviceManagements"
                        to="/services/serviceManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="subscriberManagements"
                        to="/subscribermanages/subscriberManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'serviceManagements', 
                route: '/services/serviceManagements',
                ImageUrl: '',
            },
            { 
                title: 'SubscriberManagement', 
                description: '', 
                key: 'subscriberManagements', 
                route: '/subscribermanages/subscriberManagements',
                ImageUrl: '',
            },
